...
lib.ssMetadata = [
		{name:"cupones_atlas_1", frames: [[0,0,1200,900],[0,902,851,509],[853,902,750,489]]},
		{name:"cupones_atlas_2", frames: [[0,0,1181,1181]]},
		{name:"cupones_atlas_3", frames: [[0,0,1920,1080]]}
];
...
(lib.k = function() {
	this.initialize(ss["cupones_atlas_2"]);
	this.gotoAndStop(0);
...
(lib.Mapadebits10 = function() {
	this.initialize(ss["cupones_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.Mapadebits11 = function() {
	this.initialize(ss["cupones_atlas_3"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("Egn1AWRMAAAgshMBPrAAAMAAAAshg");
	this.shape.setTransform(255,-53.25);
...
p.nominalBounds = new cjs.Rectangle(0,-195.7,510,285);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,0,0.2656,0.2639);

	this.text = new cjs.Text("5 en 1", "60px 'Cooper Black'");
	this.text.textAlign = "center";
	this.text.lineHeight = 71;
	this.text.lineWidth = 202;
	this.text.parent = this;
	this.text.setTransform(252.25,83.25);

	this.instance_1 = new lib.Símbolo10("synched",0);
	this.instance_1.setTransform(255,142.55,1,1,0,0,0,255,-53.2);
	this.instance_1.alpha = 0.5898;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance},{t:this.instance_1},{t:this.text}]},1).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,510,295.8);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,0,0.5997,0.5599);

	this.text = new cjs.Text("Pollo con pure", "60px 'Cooper Black'");
	this.text.textAlign = "center";
	this.text.lineHeight = 71;
	this.text.lineWidth = 296;
	this.text.parent = this;
	this.text.setTransform(277.75,57.6);

	this.instance_1 = new lib.Símbolo10("synched",0);
	this.instance_1.setTransform(255,338.25,1,1,0,0,0,255,142.5);
	this.instance_1.alpha = 0.5781;

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFFFF").ss(1,1,1).p("EggagN9MBA1AAAIAAb7MhA1AAAg");
	this.shape.setTransform(139.4,-127.625);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.shape},{t:this.instance},{t:this.instance_1},{t:this.text}]},1).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-69,-218,579.4,503);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,0,0.425,0.3167);

	this.text = new cjs.Text("KFC Roma", "60px 'Cooper Black'");
	this.text.textAlign = "center";
	this.text.lineHeight = 71;
	this.text.lineWidth = 204;
	this.text.parent = this;
	this.text.setTransform(255,68.1);
...
p.nominalBounds = new cjs.Rectangle(0,0,510,285);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,0,0.68,0.5829);

	this.text = new cjs.Text("Paquete mix", "60px 'Cooper Black'");
	this.text.textAlign = "center";
	this.text.lineHeight = 71;
	this.text.lineWidth = 281;
	this.text.parent = this;
	this.text.setTransform(255,64.9);
...
// stage content:
(lib.cupones = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(-57,-26,0.2648,0.2499);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape},{t:this.instance},{t:this.inicio},{t:this.menu},{t:this.ubicaciones},{t:this.cupones},{t:this.nosotros}]}).wait(1));

	// fotos
	this.instance_1 = new lib.Símbolo9();
	this.instance_1.setTransform(628,734.5,1,1,0,0,0,255,142.5);
	new cjs.ButtonHelper(this.instance_1, 0, 1, 1);

	this.instance_2 = new lib.Símbolo8();
	this.instance_2.setTransform(628.2,411.5,1,1,0,0,0,255.2,142.5);
	new cjs.ButtonHelper(this.instance_2, 0, 1, 1);

	this.instance_3 = new lib.Símbolo7();
	this.instance_3.setTransform(1254,715.5,1,1,0,0,0,255,142.5);
	new cjs.ButtonHelper(this.instance_3, 0, 1, 1);

	this.instance_4 = new lib.Símbolo6();
	this.instance_4.setTransform(1254,412.5,1,1,0,0,0,255,142.5);
...
p.nominalBounds = new cjs.Rectangle(821,424,1318.6999999999998,463.79999999999995);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/cupones_atlas_1.png?1778000352795", id:"cupones_atlas_1"},
		{src:"images/cupones_atlas_2.png?1778000352795", id:"cupones_atlas_2"},
		{src:"images/cupones_atlas_3.png?1778000352795", id:"cupones_atlas_3"}
	],
	preloads: []
};
