...
p.nominalBounds = new cjs.Rectangle(0,0,900,506);
...
p.nominalBounds = new cjs.Rectangle(0,0,900,500);


(lib.Mapadebits8 = function() {
	this.initialize(img.Mapadebits8);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,650,487);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,0,0.9867,1.14);
...
p.nominalBounds = new cjs.Rectangle(0,0,888,570);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,0,0.74,0.7143);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,0,0.9867,1.1264);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,0,0.9867,1.1265);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,0,1.3661,1.1704);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(1380,560,1,1,0,0,0,444,285);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(109).to({_off:false},0).to({alpha:1},17).wait(1));

	// foto4
	this.instance_1 = new lib.Símbolo9("synched",0);
	this.instance_1.setTransform(1379,563,1,1,0,0,0,444,285);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(75).to({_off:false},0).to({alpha:1},14).wait(38));

	// foto3
	this.instance_2 = new lib.Símbolo8("synched",0);
	this.instance_2.setTransform(1375,570,1,1,0,0,0,444,285);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(39).to({_off:false},0).to({alpha:1},20).to({_off:true},31).wait(37));

	// foto2
	this.instance_3 = new lib.Símbolo7("synched",0);
	this.instance_3.setTransform(1375,569,1,1,0,0,0,444,285);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(9).to({_off:false},0).to({alpha:1},20).to({_off:true},31).wait(67));

	// foto1
	this.instance_4 = new lib.Símbolo6("synched",0);
	this.instance_4.setTransform(1372,569,1,1,0,0,0,444,285);
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFFFF").ss(1,1,1).p("EiTMgewIsdAAEisDhEfIY3AAECsEBEgMk/QAAA");
	this.shape.setTransform(923.2,438.375);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#CC0000").s().p("EiooAS3MAAAgltMFRRAAAMAAAAltg");
...
p.nominalBounds = new cjs.Rectangle(174.3,424,1965.3999999999999,453.79999999999995);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/kpng.png?1778178463436", id:"kpng"},
		{src:"images/Mapadebits10.png?1778178463436", id:"Mapadebits10"},
		{src:"images/Mapadebits11.png?1778178463436", id:"Mapadebits11"},
		{src:"images/Mapadebits13.png?1778178463436", id:"Mapadebits13"},
		{src:"images/Mapadebits8.png?1778178463436", id:"Mapadebits8"},
		{src:"images/Mapadebits9.png?1778178463436", id:"Mapadebits9"}
	],
	preloads: []
};
